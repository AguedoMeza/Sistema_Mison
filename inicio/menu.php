	...
	<ul class="nav" id="main-menu">
        ...
        <?php 
         ...
         ?>
            ...
            <li><a class='menu' href='../departamentos/index.php' ><i class='fa fa-align-justify fa-2x'></i>Departamentos</a></li>
            ...
            <li><a class='menu' href='../compradores/index.php' ><i class='fa fa-credit-card-alt fa-lg'></i>Compradores</a></li> <!--fa fa-money-->
		...
		?>
			<li><a class='active-menu'  href='../inicio/index.php' ><i class='fa fa-home fa-2x'></i>Inicio</a></li>
			<li><a class='menu' href='../orden_compra/index.php' ><i class='fa fa-shopping-cart fa-2x'></i>Órdenes de Compra</a></li>
			<li><a class='menu' href='../cambiar_password/index.php'><i class='fa fa-unlock-alt fa-2x'></i>Cambiar Contraseña</a></li>
		<?php
		}
		if ($sTipoUsuario==3) {
		?>
