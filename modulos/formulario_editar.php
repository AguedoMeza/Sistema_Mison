				...
				<div class="row">
					<div class="col-md-12">
						...
						<?php
							...
							$qry = "SELECT id, nombre, nombre_carpeta, descripcion
								   	FROM modulos 
							   		WHERE id = '$id'";
						...
						<form action="ejecutar_editar.php" method="POST" id="formulario">
							...
							<div class="form-group col-md-6">
								...
								<input type="text" class="form-control" id="nombre" name="nombre" value="<?php echo $row[1] ?>" autofocus required/>
							</div>

							<div class="form-group col-md-6">
								<label for="categoria">Nombre Carpeta: </label>
								<input type="text" class="form-control" id="nombre_carpeta" name="nombre_carpeta" value="<?php echo $row[2] ?>" required/>                                                                         
							</div>


							<div class="form-group col-md-12">
								<label for="descripcion">Descripción: </label>
								<input  <textarea  class="form-control" cols="12" id="descripcion" name="descripcion" value="<?php echo $row[3] ?>" required/> </textarea> 								
							</div>
