<?php
	...
	$nombre_comprador = $p_nombre." ".$p_ap_paterno." ".$p_ap_materno;
	...
	$consulta="INSERT INTO compradores (nombre,ap_paterno,ap_materno,  fecha,hora,activo,usuario)
	 VALUES('$p_nombre','$p_ap_paterno','$p_ap_materno','$fecha','$hora','1','$s_idUsuario')";
	$qry=mysqli_query($conexion,$consulta) or die (mysqli_connect_error());

	 $consulta2="INSERT INTO usuarios(nombre_usuario,nombre_completo,pass,fecha,hora,activo,usuario,perfil)
	 VALUES('$usuarioC','$nombre_comprador','$pass','$fecha','$hora',1,'$s_idUsuario',2)";
