		...
		<div id="page-wrapper" >
			<div id="page-inner">
					...
					<div class="col-md-12">
						...
						<form action="ejecutar_editar.php" method="POST" id="formulario">
							<div class="form-group col-md-6">
								...
								<input type="password" class="form-control" id="pass" name="pass" placeholder="Introduzca su contraseña" autofocus required>
							</div>

							<div class="form-group col-md-6">
								<label for="repassword">Repita su Contraseña: </label>
								<input type="password" class="form-control" id="repassword" name="repassword" placeholder="Repita su contraseña" autofocus required>
							</div>
							
							
						
							<div style="color: white; padding: 15px 50px 5px 50px; float: right; font-size: 16px;">
								<input type="submit" value="Guardar" class="btn btn-danger"></div>
						</form>
				...
				<!--<div class="row">
					<div class="col-lg-12">
						<br><hr>
						<?php// include'tabla_password.php' ?>
					</div> 
				</div>-->
			</div>
		</div>
