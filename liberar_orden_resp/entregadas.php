			...
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						...
						<h2>Ordenes de la Semana</h2>
		
						
						     <div class="row">
					<div class="col-lg-12">
						<br><hr>
						<?php include'tabla_orden_semana.php' ?>
					</div> 
				</div>
                            ...
                            <tr align="center" > 
                                <td  action="../orden_compra/retraso.php">
                                    <form action="../orden_compra/orden_dia.php">
                                      <td   height="100"><button name="btn" class="btn btn-danger">Ordenes del Día</button></td>
                                    </form>
                                    </td> 
                                <td  action="../orden_compra/entregadas.php">
                                    <form action="../orden_compra/retraso.php">
                                      <td   height="100"><button name="btn" class="btn btn-danger">Ordenes de Retraso</button></td>
                                    </form>
