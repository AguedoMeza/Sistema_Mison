...
$qry = "SELECT  detalle_descuento.id, CONCAT(proveedores.numero_proveedor, ' ',proveedores.proveedor) AS nombreP, descuentos.descuentos, detalle_descuento.id_descuento, detalle_descuento.id_proveedor, detalle_descuento.descuento, detalle_descuento.detalle FROM detalle_descuento
		...
		WHERE detalle_descuento.id = '$id'";
						...
						<form  method="POST" id="formulario" action="actualizar_detalle_perfil.php ?>">
							...
							<div class="form-group col-md-6">
								<label for="id_proveedor">Proveedor: </label>
								 ...
								 <select  class="form-control" id="id_proveedor" name="id_proveedor" id="id_proveedor" >
               ...
               FROM proveedores");
							...
							<div class="form-group col-md-6">
								<label for="sucursal">Descuento: </label>
								<?php 
							...
							<div class="form-group col-md-6">
								...
								<input type="text" class="form-control" id="descuento" value="<?php echo $otro[5];?>" name="descuento">
							</div>

							<div class="form-group col-md-6">
								<label for="detalle">Detalle: </label>
								<input <textarea class="form-control" cols="12" id="detalle" value="<?php echo $otro[6];?>" name="detalle"> </textarea>
							</div> 
