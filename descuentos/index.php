					...
					<div class="col-md-12">
						...
						<form action="insertar_modulos.php" method="POST" id="formulario">
							<div class="form-group col-md-6">
								...
								<input type="text" class="form-control" id="descuentos" name="descuentos" placeholder="Ej. Descuento por no devolución" autofocus required>
							</div>
							
							<div class="form-group col-md-6">
								<label for="detalle">Detalle: </label>
								<textarea class="form-control" cols="12" id="detalle" placeholder="Descripcion del descuento" name="detalle"></textarea>
							</div>
