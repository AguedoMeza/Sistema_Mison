				...
				<div class="row">
					<div class="col-md-12">
						...
						<?php
							...
							$qry = "SELECT id, descuentos, detalle
								   	FROM descuentos 
							   		WHERE id = '$id'";
						...
						<form action="ejecutar_editar.php" method="POST" id="formulario">
							...
							<div class="form-group col-md-6">
								...
								<input type="text" class="form-control" id="descuentos" name="descuentos" value="<?php echo $row[1] ?>" autofocus required/>
							</div>
							...
							<div class="form-group col-md-6">
								...
								<input  <textarea  class="form-control" cols="12" id="detalle" name="detalle" value="<?php echo $row[2] ?>" required/> </textarea> 
								
							</div>


							<div style="color: white; padding: 15px 50px 5px 50px; float: right; font-size: 16px;">
								<input type="submit" value="Editar" class="btn btn-danger"></div>
