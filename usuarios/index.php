			...
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						...
						<form action="insertar_tipo_usuario.php" method="POST" id="formulario">
							...
							<div class="form-group col-md-6">
								<label for="cadena">Contraseña: </label>
								<input type="password" class="form-control" id="pass" name="cadena">
							</div>
							<?php
           					 include("../configuracion/conexion.php");
               				 $qry = "SELECT id, nombre FROM perfil ORDER BY id";
