		...
		<div id="page-wrapper" >
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						...
						<?php
							...
							$qry = "SELECT id, nombre_usuario, nombre_completo, pass, perfil, fecha, hora, activo, usuario
								   	FROM usuarios 
							   		WHERE id = '$id'";
						...
						<form action="ejecutar_editar.php" method="POST" id="formulario">
							...
							<div class="form-group col-md-6">
								...
								<input type="text" class="form-control" id="nombre_usuario" name="nombre_usuario" value="<?php echo $row[1] ?>" autofocus required/>
							</div>
							...
							<div class="form-group col-md-6">
								...
								<input type="text" class="form-control" id="nombre_completo" name="nombre_completo" value="<?php echo $row[2] ?>" required/>                                                                         
							</div>


							<div class="form-group col-md-6">
								<label for="pass">Contraseña: </label>
								<input type="password" class="form-control" id="pass" name="pass" value="<?php echo $row[3] ?>" readonly/>                                                                         
							</div>
							<?php
           					 include("../configuracion/conexion.php");

               				 $qry = "SELECT id, nombre
                      				  FROM perfil 
							...
							<br>
								...
								<select class="form-group col-md-6" name="perfil">
								<?php
							...
							<div style="color: white; padding: 15px 50px 5px 50px; float: right; font-size: 16px;">
								<input type="submit" value="Restablecer contraseña" class="btn btn-danger square-btn-adjust"></div>
				...
				<div class="row">
					<div class="col-lg-12">
						<br><hr>
						<?php include'tabla_tipo_usuario.php' ?>
					</div> 
				</div>
			</div>
		</div>
