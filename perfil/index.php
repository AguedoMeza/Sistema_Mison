			...
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						...
						<h2>Perfiles</h2>
						<hr>
						<form  method="POST" id="formulario" action="insertar_perfil.php ?>">
							

							<div class="form-group col-md-12">
								<label for="cantidad">Nombre: </label>
								<input type="textr" class="form-control" id="nombre" name="nombre">
							</div>
							<div class="form-group col-md-12">
								<label for="fecha_llegada">Descripcion: </label>
